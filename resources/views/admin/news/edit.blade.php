...
@section('content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul
        <small>Edit News Product</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Modul</li>
        <li class="active">Edit News Product</li>
      </ol>
    </section>
	                ...
	                <div class="panel box ">
	                  <div class="box-header with-border">
	                    <h4 class="box-title pull-right">
	                      <a href="{{url('/news/modul')}}">
	                        <i class="fa fa-arrow-left"></i> Back
	                      </a>
	                    </h4>
	                  </div>
	                      <form role="form" action="{{url('/updatemodulnews')}}" method="post" enctype="multipart/form-data">
                          {!! csrf_field() !!}
			              <div class="box-body">
			                ...
			                <div class="form-group">
			                  <label>Image</label>
			                  <input type="file" name="image" value="{{$data->image}}" class="form-control-file">
